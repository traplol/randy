...
./out/randy -c src/randy/main.randy -o bootstrap/randy1 -ld -dynamic-linker /home/max/workspace/musl-1.2.4/lib/libc.so -lc
...
bootstrap/randy1 -c src/randy/main.randy -o bootstrap/randy2 -ld -dynamic-linker /home/max/workspace/musl-1.2.4/lib/libc.so -lc
